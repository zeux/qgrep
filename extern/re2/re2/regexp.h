...
class RE2_API Regexp {
 public:
  ...
  friend string Dump(Regexp &regexp);
  ...
  friend void NullWalk(Regexp& prog);
...
class RE2_API CharClassBuilder {
 public:
  CharClassBuilder();
