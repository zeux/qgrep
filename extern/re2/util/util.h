...
string RE2_API CEscape(const StringPiece& src);
int CEscapeString(const char* src, int src_len, char* dest, int dest_len);

extern string RE2_API StringPrintf(const char* format, ...);
extern void RE2_API SStringPrintf(string* dst, const char* format, ...);
extern void RE2_API StringAppendF(string* dst, const char* format, ...);
