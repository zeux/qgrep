...
SOURCES+=src/blockpool.cpp src/build.cpp src/encoding.cpp src/entrypoint.cpp src/files.cpp src/fileutil.cpp src/fileutil_posix.cpp src/fileutil_win.cpp src/fuzzymatch.cpp src/info.cpp src/init.cpp src/main.cpp src/orderedoutput.cpp src/project.cpp src/regex.cpp src/search.cpp src/stringutil.cpp src/update.cpp src/workqueue.cpp
